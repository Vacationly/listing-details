...
describe('rendering', () => {
  ...
  it('should NOT display action link when "description" prop is empty', () => {
    const wrapper = mount(<CancellationPolicy {...semiEmptyProps} />);
